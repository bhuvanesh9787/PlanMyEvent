...
<head>
  <meta charset="UTF-8">
  <title>Register Organiser — Plan My Event</title>
  <style>
    *{box-sizing:border-box;margin:0;padding:0;}
    ...
    .btn:hover{transform:translateY(-2px);box-shadow:0 10px 28px rgba(123,47,247,0.45);}
    .bottom{text-align:center;margin-top:20px;font-size:13px;color:#888;}
    .bottom a{color:#7b2ff7;font-weight:700;text-decoration:none;}
  </style>
</head>
<body>
<div class="box">
  <div class="top">
    <div class="icon">🎭</div>
    <h1>Plan My Event</h1>
    <p>Register as an Organiser</p>
  </div>
  <% if (error != null) { %>
    <div class="alert">⚠️ <%= error %></div>
  <% } %>
  <form action="<%= request.getContextPath() %>/register" method="post">
    <input type="hidden" name="type" value="organiser">
    <div class="form-row">
    ...
    <div class="form-group">
      ...
      <input type="text" name="orgName" required placeholder="Your organisation name">
    </div>
    <div class="form-group">
      <label>Address</label>
    ...
    <div class="form-group">
      ...
      <input type="text" name="idProof" required placeholder="Aadhaar / PAN / Passport">
    </div>
    <div class="form-group">
      <label>Password</label>
      <input type="password" name="password" required placeholder="Create a strong password">
    </div>
    <button type="submit" class="btn">🎭 Register as Organiser</button>
  </form>
  <div class="bottom">
